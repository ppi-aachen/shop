...
type CarouselCorePlugins = Parameters<typeof useEmblaCarousel>[0]
type CarouselOptions = Parameters<typeof useEmblaCarousel>[1]
type CarouselPlugin = Parameters<typeof useEmblaCarousel>[2]
