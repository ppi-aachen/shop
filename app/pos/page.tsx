                ...
                <div className="space-y-4">
                  <div>
                    <div className="flex items-center">
                      {selectedProduct.discount && selectedProduct.discount > 0 ? (
                        <>
                          <p className="text-gray-500 text-sm line-through mr-2">€{selectedProduct.price.toFixed(2)}</p>
                  ...
                  <div className="pt-4">
                    ...
                    >
                      ...
                      {currentVariantStock > 0
                        ? `Add to Cart - €${calculateDiscountedPrice(selectedProduct.price, selectedProduct.discount).toFixed(2)}`
                        : "Out of Stock"}
                    </Button>
                  </div>
                </div>
